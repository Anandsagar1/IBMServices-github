...
function (_Component) {
  ...
  _createClass(Tile, [{
    ...
    value: function render() {
      ...
      var tileClasses = (0, _classnames.default)("".concat(prefix, "--tile"), className);
...
function (_Component2) {
  ...
  _createClass(ClickableTile, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)("".concat(prefix, "--link"), "".concat(prefix, "--tile"), "".concat(prefix, "--tile--clickable"), _defineProperty({}, "".concat(prefix, "--tile--is-clicked"), this.state.clicked), className);
...
function (_Component3) {
  ...
  _createClass(SelectableTile, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)("".concat(prefix, "--tile"), "".concat(prefix, "--tile--selectable"), _defineProperty({}, "".concat(prefix, "--tile--is-selected"), this.state.selected), className);
      ...
      }, _react.default.createElement(_iconsReact.CheckmarkFilled16, {
        "aria-label": iconDescription
      }, iconDescription && _react.default.createElement("title", null, iconDescription))), _react.default.createElement("div", {
...
function (_Component4) {
  ...
  function ExpandableTile() {
    ...
    _defineProperty(_assertThisInitialized(_this4), "uid", (0, _uniqueId.default)());
  ...
  _createClass(ExpandableTile, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)("".concat(prefix, "--tile"), "".concat(prefix, "--tile--expandable"), _defineProperty({}, "".concat(prefix, "--tile--is-expanded"), expanded), className);
      var tileStyle = {
      ...
      return (// eslint-disable-next-line jsx-a11y/click-events-have-key-events,jsx-a11y/no-static-element-interactions
        _react.default.createElement("div", _extends({
          ...
          description: expanded ? tileExpandedIconText : tileCollapsedIconText
        })), _react.default.createElement("div", {
