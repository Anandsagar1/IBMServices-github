...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-jy9e8mnd6b">Show
  modal</button>

<div data-modal id="modal-jy9e8mnd6b" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-jy9e8mnd6b-label" aria-describedby="modal-jy9e8mnd6b-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jy9e8mnd6b-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jy9e8mnd6b-heading">Modal heading</p>
