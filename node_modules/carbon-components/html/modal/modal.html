...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-qz8iqv04dcb">Show
  modal</button>

<div data-modal id="modal-qz8iqv04dcb" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-qz8iqv04dcb-label" aria-describedby="modal-qz8iqv04dcb-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-qz8iqv04dcb-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-qz8iqv04dcb-heading">Modal heading</p>
