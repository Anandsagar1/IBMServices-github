...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-zjnhq8zh6c">Show
  modal</button>

<div data-modal id="modal-zjnhq8zh6c" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-zjnhq8zh6c-label" aria-describedby="modal-zjnhq8zh6c-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-zjnhq8zh6c-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-zjnhq8zh6c-heading">Modal heading</p>
